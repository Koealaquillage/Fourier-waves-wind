...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 16 16:21:58 2020
Here we look at the time evolution of the infragravity waves
...
#    time = dates.num2date(time)
    ...
    eta = gaussian_filter1d(eta,sigma = 20)
    # And we plot
    ax_eta.plot(time, eta, label=stat)

ax_eta.legend(loc='best')
ax_eta.set_ylabel('Significative infragravity wave height (m)')
