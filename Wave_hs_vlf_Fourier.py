...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 16 13:04:01 2020
Here we plot the spectrum for the very low frequencies waves
...
#    time = dates.num2date(time)
    ...
    # And we smooth it
    fft_wave_2 = gaussian_filter1d(fft_wave_2.real,sigma =3)
...
ax_wave.set_ylabel('Very-low frequency power (m^2)')
